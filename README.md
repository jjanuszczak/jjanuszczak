...
Building the systems that scale from zero to >100B GTV. Former CEO @ UBX. Astrophysicist turned builder. Building ventures & guiding boards/leaderhsip teams on AI, Fintech & Energy Transition.

I create **AI-native tools and infrastructure** that turn chaotic workflows into durable, version-controlled knowledge. Current obsessions: agentic systems, markdown-first everything, and developer tools that actually ship.

[![Website](https://img.shields.io/badge/Website-januszczak.org-4B0082?style=for-the-badge&logo=google-chrome&logoColor=white)](https://januszczak.org/)
